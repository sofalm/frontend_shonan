...
@Component({
  selector: 'app-energy-types',
  templateUrl: './energy-types.component.html',
  styleUrls: ['./energy-types.component.scss'],
    providers: [DialogService]
})
export class EnergyTypesComponent implements OnInit, OnDestroy {
    ...
    loadData() : void {
        this.loading = true
        this.catalogService.getEnergiesPaginate(this.dataPaginate).subscribe((response) => {
