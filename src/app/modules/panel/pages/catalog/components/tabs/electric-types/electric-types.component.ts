...
@Component({
  selector: 'app-electric-types',
  templateUrl: './electric-types.component.html',
  styleUrls: ['./electric-types.component.scss'],
    providers: [DialogService]
})
export class ElectricTypesComponent implements OnInit, OnDestroy {
    ...
    loadData() : void {
        this.loading = true
        this.catalogService.getElectricsPaginate(this.dataPaginate).subscribe((response) => {
