...
export class DesignTypesComponent implements OnInit, OnDestroy {
    ...
    loadData() : void {
        this.loading = true;
        this.catalogService.getDesignsPaginate(this.dataPaginate).subscribe((response) => {
